...
@Configuration
@EnableWebSecurity
@ComponentScan("com.ys.springAuth.security")
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder authManagerBuilder) throws Exception {
		authManagerBuilder.ldapAuthentication().userDnPatterns(ldapAuthStructure.getUserDnPattern())
				.userSearchBase(ldapAuthStructure.getUserSearchBase()).contextSource()
				...
				.and().passwordCompare().passwordEncoder(new LdapShaPasswordEncoder())
